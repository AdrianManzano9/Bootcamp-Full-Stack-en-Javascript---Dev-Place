...
export function Carousel() {
  let { setCount, productos } = useContext(AppContext)
                ...
                <div className=" d-flex flex-wrap justify-content-center">
                  ...
                  <div className="carousel-text d-flex flex-column w-25 mx-1 align-self-center">
                    ...
                    <p>{prod.descrip}</p>
                    {
                      ...
                      <p className="cantD">Cantidad disponible: {prod.cantD}</p>
                      </>}
                        </div>
                    }
                  </div>
              ...
              <p>{productos[4].descrip}</p>
              {
                productos[4].cant === 0 ? <button type="button" className='compar' onClick={() => { productos[4].cant += 1; setCount((c) => c + 1) }}>Comprar</button>
                  ...
                  <div className="d-flex flex-row count">
                    ...
                    {productos[4].cant < productos[4].cantD ?
                      <button type='button' onClick={() => { productos[4].cant += 1; setCount((c) => c + 1) }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z" />
                      </svg></button> :<>
                      <button type='button'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z" />
                      </svg></button>
                      <p className="cantD">Cantidad disponible: {productos[4].cantD}</p>
                      </>}
                  </div>
              }
            </div>

...
export function Cart() {
    ...
    const handleSubmit = (event) => {
        ...
        if (Object.values(inputs).length === 6 && inputs.tPago !== "Tarjeta de crédito" && inputs.tPago !== "Tarjeta de débito") {
            console.table(inputs)
            alert("Guadado Exitosamente")
        } else if (Object.values(dateCard).length === 2 && Object.values(inputs).length === 6) {
            ...
            <form onSubmit={handleSubmit} className=" form p-4">
                <div className="mb-1">
                    ...
                    <input
                        name="name"
                        value={inputs.name}
                        onChange={handleChange} type="text" className="form-control  h-25" id="name" />
                </div>
                <div className="mb-1">
                    <label
                    ...
                    <input name="surname"
                        ...
                        onChange={handleChange} type="text" className="form-control  h-25" id="Apellido" />
                </div>
                <div className="mb-1">
                    <label
                        className="form-label">Correo electronico</label>
                    <input name="email"
                        value={inputs.email}
                        onChange={handleChange} type="email" className="form-control  h-25" id="exampleInputEmail1" aria-describedby="emailHelp" />
                </div>
                <div className="mb-1">
                    <label
                    ...
                    inputs.tPago === "Tarjeta de crédito" || inputs.tPago === "Tarjeta de débito" ?
                        <>
                            <div className="mb-1 d-flex flex-row flex-wrap">
                                ...
                                <div>
                                    <label name="venTarjeta"
                                        value={inputs.venTarjeta}
